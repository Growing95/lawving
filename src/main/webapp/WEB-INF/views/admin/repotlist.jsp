						...
						<tr>
							<td colspan="4" class="paging">
								<!-- 이전 --> <c:choose>
									...
									<c:otherwise>
										<a
											href="repotlist.do?cPage=${paging.beginBlock-paging.pagePerBlock }">이전으로</a>
									</c:otherwise>
									...
									<c:choose>
										...
										<c:otherwise>
											<a href="repotlist.do?cPage=${k}">${k}</a>
										</c:otherwise>
									</c:choose>
									...
									<c:otherwise>
										<a
											href="repotlist.do?cPage=${paging.beginBlock+paging.pagePerBlock }">다음으로</a>
									</c:otherwise>
								</c:choose>
							</td>
						</tr>
