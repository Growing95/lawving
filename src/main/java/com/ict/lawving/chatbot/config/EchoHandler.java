...
public class EchoHandler extends TextWebSocketHandler {
	...
	protected void handleTextMessage(WebSocketSession session, TextMessage message) throws Exception {
			...
			}else if(message.getPayload().equals("챗봇")){
				session.sendMessage(new TextMessage("챗봇 : "+"<strong>"+"챗봇 기능은 로그인을 한 회원이 사용할 수 있는 기능으로"+
						"카카오로그인을 한 임시회원은 사용할 수 없는 기능입니다."+"</strong><br>"));
			}else if(message.getPayload().equals("법률")){
